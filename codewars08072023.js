...
// My Solution  => first is just brute force

   // for(let i = 0; i < abc.length; i++){
//     if(theVariables[0] == abc[i]) {
//       res += i
//     }
//     if(theVariables[2]== abc[i]) {
//       res += i;
//     }
//   }
//   return res
// } second solution is optimized for time and spave

const theVar = v => v.charCodeAt(0) + v.charCodeAt(2) - 192
